  ...
  return (
    <div className="intro-container container">
      ...
      <div className="intro-text">
        ...
        <br />
        <br />I currently manage a team of developers, front, back and native at
        ...
        <br />
        <br />
        Here you will find links to several projects I work on or have developed
        and some frontend experiments.
      </div>
      <span className="code-help">{"</Intro>"}</span>
    </div>
  );
